...
.prototype.activateADA=function(){this.$slideTrack.find(".slick-active").attr({"aria-hidden":"false",tabindex:"-1"}) // tabindex:"-1" 추가 //ul > li > a 형태 일 때, li에 tabindex 중복 제거
.find("a, input, button, select").attr({tabindex:"0"})} // ul > li > a 형태 일 때, a에 tabindex 들어가므로
